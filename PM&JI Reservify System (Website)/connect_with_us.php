...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $other_concern = !empty($_POST['other_concern']) ? htmlspecialchars(trim($_POST['other_concern'])) : null;
    ...
    try {
        // Get the current count of tickets for the day
        $query = "SELECT COUNT(*) AS ticket_count FROM customer_service_inquiries WHERE DATE(created_at) = CURDATE()";
        ...
        $query = "INSERT INTO customer_service_inquiries 
        ...
        echo "<p class='success-message'>Thank you for your submission! Your ticket number is <strong>$ticket_number</strong>.</p>";
